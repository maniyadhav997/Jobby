...
import ProfileDetsils from '../ProfileDetails'
import './index.css'
...
const FiltersGroup = props => {
  ...
  const renderTypeOfEmployment = () => {
    ...
    return (
      <div className="employmnt-type-container">
        <h1 className="employmnt-type-heading">Type of Employment</h1>
        <ul className="employmnt-type-list-container">
